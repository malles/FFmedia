...
<?php if ($this->params->get('show_contact_list') && count($this->contacts) > 1) : ?>
    <div class="uk-clearfix uk-margin">
        <form class="uk-form" action="#" method="get" name="selectForm" id="selectForm">
...
<div class="uk-margin">
    <?php if ($this->contact->name && $this->params->get('show_name')) : ?>
        <h1 class="tm-title"><?php echo $this->contact->name; ?></h1>
    <?php endif;  ?>
        ...
        <div class="uk-width-1-2 ">
            <div class="uk-panel uk-panel-box">
                <?php if ($this->contact->misc && $this->params->get('show_misc')) : ?>
                    <h3><i class="uk-icon-info-circle uk-text-primary uk-margin-small-right"></i><?php echo JText::_('COM_CONTACT_OTHER_INFORMATION'); ?></h3>
        ...
        <div class="uk-width-1-2">
            <div class="uk-panel uk-panel-box uk-flex uk-flex-center uk-flex-middle">
                <?php if ($this->contact->image && $this->params->get('show_image')) : ?>
                    <?php echo JHtml::_('image', $this->contact->image, JText::_('COM_CONTACT_IMAGE_DETAILS'), array('style' => '')); ?>
                <?php endif; ?>
            </div>
        </div>
    </div>
