...
<div class="uk-grid" data-uk-grid-match="{target:'.uk-panel'}">
    <div class="uk-width-medium-1-2">
        <div class="uk-panel uk-panel-box">
            <h3><i class="uk-icon-home uk-text-primary uk-margin-small-right"></i><?php echo JText::_('COM_CONTACT_ADDRESS'); ?></h3>
            <ul class="uk-list">
...
<?php if ( ($this->contact->email_to && $this->params->get('show_email')) ||
    ...
    <div class="uk-width-medium-1-2">
        <div class="uk-panel uk-panel-box">
            <h3><i class="uk-icon-user uk-text-primary uk-margin-small-right"></i><?php echo JText::_('COM_CONTACT_DETAILS'); ?></h3>
            <ul class="uk-list">
